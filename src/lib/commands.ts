...
export const commandSets: CommandSet[] = [
	...
	{ command: 'カース > 片手 > スケゴ > 片手 > 集中', durationMs: DEFAULT_DURATION },
	{ command: 'カース > 片手 > スケゴ > 片手 > 両手 > 集中', durationMs: DEFAULT_DURATION },
	{ command: 'カース > 片手 > スケゴ > 両手 > 集中', durationMs: DEFAULT_DURATION },

	{ command: 'カース > 片手 > 両手 > スケゴ > 集中', durationMs: DEFAULT_DURATION },
	...
	{ command: '両手 > カース > 片手 > 両手 > 集中', durationMs: DEFAULT_DURATION },
